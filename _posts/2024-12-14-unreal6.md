...
<div style="display: flex; justify-content: center; align-items: center;">
  <video width="640" height="360" autoplay muted loop>
    <source src="/assets/mp4/24-12-14/blendSpace1.gif" type="video/webm">
...
이건 트랜지션 룰이다. 여기서 현재 상태에서 다른 상태로 넘어갈 조건을 정해줄 수 있다.
...
스테이트 에일리어스는 스테이트 머신의 연결 구조를 좀 더 깔끔하게 정리할 수 있는 기능이다.
