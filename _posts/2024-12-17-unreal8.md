...
<div style="width: 500px; overflow: hidden; position: relative;">
    <div id="slider1" style="display: flex; transition: transform 0.5s ease;">
        <img src="/assets/image/2024-12-17/BCE-B.png" style="width: 700px;">
        <img src="/assets/image/2024-12-17/BCE-C.png" style="width: 700px;">
        <img src="/assets/image/2024-12-17/BCE-E.png" style="width: 700px;">
    </div>
    <button id="slider1-prev" style="position: absolute; top: 50%; left: 0;">&#10094;</button>
    <button id="slider1-next" style="position: absolute; top: 50%; right: 0;">&#10095;</button>
</div>
...
<!-- 두 번째 슬라이더 -->
<div style="width: 500px; overflow: hidden; position: relative;">
    <div id="slider2" style="display: flex; transition: transform 0.5s ease;">
        <img src="/assets/image/2024-12-17/ARM-A.png" style="width: 500px;">
        <img src="/assets/image/2024-12-17/ARM-R.png" style="width: 500px;">
        <img src="/assets/image/2024-12-17/ARM-M.png" style="width: 500px;">
    </div>
    <button id="slider2-prev" style="position: absolute; top: 50%; left: 0;">&#10094;</button>
    <button id="slider2-next" style="position: absolute; top: 50%; right: 0;">&#10095;</button>
</div>
...
<script>
    function createSlider(sliderId) {
        ...
        function showSlide(index) {
            ...
            const offset = -500 * currentIndex;
            slider.style.transform = `translateX(${offset}px)`;
        }

        document.getElementById(sliderId + "-next").onclick = () => showSlide(currentIndex + 1);
        document.getElementById(sliderId + "-prev").onclick = () => showSlide(currentIndex - 1);
    }
